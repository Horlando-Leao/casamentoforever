---
name: creator-skills
description: Cria a skills necessárias para o desenvolvimento de um projeto, como scripts, templates, documentação, etc. Use quando precisar de criar ou estruturar uma nova skill.
---
