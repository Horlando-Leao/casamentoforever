    ...
    try {
      ...
      if (!event || !event.endereco) {
        showModal({
          ...
          message:
            "Nenhum endereço de convite foi cadastrado. Deseja adicionar o endereço antes de compartilhar?",
    ...
    try {
      ...
      if (!event || !event.endereco) {
        showModal({
          title: "Adicionar Endereço?",
          message:
            "Nenhum endereço foi cadastrado. Deseja adicionar antes de enviar pelo WhatsApp?",
          confirmLabel: "Sim, Adicionar",
  ...
  return (
    <div className="min-h-dvh bg-cream">
      ...
      {currentPage === "dashboard" && tenant && (
        <Dashboard
          ...
          onShareInvitationWhatsApp={() =>
            handleShareInvitationWhatsApp(tenant)
          }
          showModal={showModal}
        />
      )}
      ...
      {currentPage === "public-event" && qrToken && (
        <PublicEventDetail qrToken={qrToken} />
      )}
