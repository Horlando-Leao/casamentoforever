...
import { deleteGift, getEventDetails, getGifts } from "../services/api";
            ...
            >
              <div className="flex rounded-xl border border-gold-light/50 bg-white shadow-sm overflow-hidden">
                ...
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className={`h-4 w-4 transition-transform duration-200 ${shareDropdownOpen ? "rotate-180" : ""}`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 mb-8">
              <div>
                ...
                <p className="text-text-secondary">
                  {gifts.length}{" "}
                  {gifts.length === 1 ? "item cadastrado" : "itens cadastrados"}
                </p>
              </div>
            ...
            {gifts.length === 0 ? (
              <div className="text-center py-20 bg-white rounded-3xl shadow-soft border border-cream-dark">
                ...
                <p className="text-text-secondary max-w-md mx-auto mb-8">
                  Comece adicionando presentes que vocês gostariam de receber.
                  Seus convidados verão a lista em um link exclusivo.
                </p>
                <button
                  onClick={onNewGift}
