...
export default function Register({ onRegisterSuccess, onLoginClick }) {
  ...
  return (
    <div className="min-h-screen bg-cream flex flex-col md:flex-row-reverse selection:bg-rose-gold/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Ex: João"
                  className="w-full px-5 py-3.5 bg-gray-50/50 border border-cream-dark rounded-xl focus:ring-2 focus:ring-gold-light focus:border-gold outline-none transition-all placeholder-gray-400"
                />
              </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-5 py-3.5 bg-gray-50/50 border border-cream-dark rounded-xl focus:ring-2 focus:ring-gold-light focus:border-gold outline-none transition-all tracking-widest placeholder:tracking-normal placeholder-gray-400"
              />
            </div>
